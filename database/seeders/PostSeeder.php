...
class PostSeeder extends Seeder
{
    ...
    {
        // Blog kapak görsellerini (telifsiz) public diske kopyala.
        ...
        $posts = [
            [
                ...
                'cover_image' => 'posts/kaygi-bozuklugu.jpg',
            ...
            [
                ...
                'cover_image' => 'posts/saglikli-iliski.jpg',
                'status' => PostStatus::Published,
            ...
            [
                ...
                'cover_image' => 'posts/stres-yonetimi.jpg',
                'status' => PostStatus::Published,
    ...
    /**
     * Seeder ile birlikte gelen telifsiz kapak görsellerini
     * (database/seeders/assets/posts) public diske (storage/app/public/posts) kopyalar.
     */
    private function copyCoverImages(): void
    {
        $source = database_path('seeders/assets/posts');
